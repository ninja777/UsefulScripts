...
file1 = '../server11_ifiles/results/OUT-MHOOK-AHOOK-EQUAL.txt'
file2 = '../server12_ifiles/results/OUT-MHOOK-AHOOK-EQUAL.txt'

a = o.ocamlOutputFile(filename=file1)
a.parseFile()


b = o.ocamlOutputFile(filename=file2)
b.parseFile()
